...
class FolderController extends GetxController {
  ...
  List<String> desiredFolders = [
    'JSPS Konuları',
    'Müşterek Konular',
    'Diğer Branş Personelin JSPS Konu ve Kapsamları',
    'Havacılık Branşı Personelin JSPS Konu ve Kapsamları',
    'Personel Branşı Personelin JSPS Konu ve Kapsamları',
    'MEBS Branşı Personelin JSPS Konu ve Kapsamları',
    'Maliye Branşı Personelin JSPS Konu ve Kapsamları',
  ];
