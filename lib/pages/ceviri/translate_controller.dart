...
import 'package:jsps_depo/pages/ceviri/my_dialog.dart';
import 'package:jsps_depo/pages/ceviri/yz_apis.dart';
...
class TranslateController {
  ...
  final to = ValueNotifier<String>('Türkçe');
  ...
  Future<void> googleTranslate(BuildContext context) async {
    if (textC.text.trim().isNotEmpty && to.value.isNotEmpty) {
      ...
      if (to.value.isEmpty) MyDialog.info(context, 'Select To Language!');
      if (textC.text.isEmpty) {
        MyDialog.info(context, 'Type Something to Translate!');
      }
    }
  }
